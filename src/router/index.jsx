...
const FormBuilderPage = lazy(() => import("@/components/pages/FormBuilder"))
const FormResponsesPage = lazy(() => import("@/components/pages/FormResponses"))
const FormPreviewPage = lazy(() => import("@/components/pages/FormPreview"))
...
const mainRoutes = [
  ...
  },
  {
    ...
    element: <Suspense fallback={suspenseFallback}><FormPreviewPage /></Suspense>
  },
  {
    path: "*",
